...
import { OrganizationProjectOrgCustomerSelectModal } from '@/components/organization/project/modals/organization-project-org-customer-select-modal/organization-project-org-customer-select-modal';
import { OrganizationProjectNoteEditModal } from '@/components/organization/project/modals/organization-project-note-edit-modal/organization-project-note-edit-modal';

export function OrganizationProjectDetailFooterContent() {
  ...
  return (
    <>
      ...
      <OrganizationProjectOrgCustomerSelectModal
        modalRef={selectCustomerModalRef}
      />

      <OrganizationProjectNoteEditModal
        value={note}
        isLoading={isLoading}
        modalRef={noteModalRef}
        onConfirm={(noteValue: string, onSuccessClose?: () => void) => {
          handleUpdateProject({ note: noteValue }, onSuccessClose);
        }}
      />
    </>
  );
