...
import { updateTourSettlementApi } from '@/apis/tour/tour-settlement';
import { UpdateTourSettlementRequest } from '@/interfaces/tour-settlement-interfaces';
...
export function TourSettlementTicketSummary({
  ...
  const updateTourSettlementFn = (updatedFields: UpdateTourSettlementRequest) =>
    updateTourSettlementApi(id, updatedFields);
          ...
          <View style={styles.row}>
            ...
            <View style={styles.rightColumn}>
              <Text style={[styles.columnText, styles.boldText, styles.textRight]}>
                Giá bán <Text style={styles.normalWeight}>(thực tế)</Text>
              </Text>
            </View>
          </View>
