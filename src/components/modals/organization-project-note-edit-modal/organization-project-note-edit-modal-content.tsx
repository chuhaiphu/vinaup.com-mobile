...
interface OrganizationProjectNoteEditModalContentProps {
  maxLength?: number;
  value?: string | null;
  placeholder?: string;
  isLoading?: boolean;
...
export function OrganizationProjectNoteEditModalContent({
  maxLength = 100,
  value = '',
  placeholder,
  isLoading = false,
  onConfirm,
  onCloseRequest,
}: OrganizationProjectNoteEditModalContentProps) {
