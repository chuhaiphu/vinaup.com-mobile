...
/**
 * Tính tổng hợp thu/chi theo kênh (BANK/CASH) và loại (RECEIPT/PAYMENT).
 *
 * @param receiptPayments - Danh sách giao dịch. Truyền undefined/null để nhận object zero.
 * @returns { bankIn, bankOut, cashIn, cashOut, totalReceipt, totalPayment, totalRemaining }
 *   Đơn vị VND. totalRemaining = totalReceipt − totalPayment.
 */
